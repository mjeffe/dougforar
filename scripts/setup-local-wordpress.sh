...
<!-- /wp:paragraph -->
<!-- wp:columns {"className":"dc-card-grid"} --><div class="wp-block-columns dc-card-grid">
<!-- wp:column --><div class="wp-block-column"><!-- wp:heading {"level":2} --><h2 class="wp-block-heading">Chris Jones</h2><!-- /wp:heading --><!-- wp:paragraph --><p>U.S. House, District 2</p><!-- /wp:paragraph --><!-- wp:buttons --><div class="wp-block-buttons"><!-- wp:button --><div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="https://secure.actblue.com/donate/chip-in-for-chris?refcode=website" target="_blank" rel="noopener" aria-label="Donate to Chris Jones via ActBlue, opens in a new tab">Donate via ActBlue</a></div><!-- /wp:button --><!-- wp:button --><div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="https://goodchange.app/donate/suppo-co?mk=web-3" target="_blank" rel="noopener" aria-label="Donate to Chris Jones via GoodChange, opens in a new tab">Donate via GoodChange</a></div><!-- /wp:button --></div><!-- /wp:buttons --><!-- wp:paragraph {"className":"dc-campaign-site"} --><p class="dc-campaign-site"><a href="https://chrisjonesforcongress.com/" target="_blank" rel="noopener" aria-label="Visit the Chris Jones campaign website, opens in a new tab">Visit campaign website</a></p><!-- /wp:paragraph --></div><!-- /wp:column -->
<!-- wp:column --><div class="wp-block-column"><!-- wp:heading {"level":2} --><h2 class="wp-block-heading">Hallie Shoffner</h2><!-- /wp:heading --><!-- wp:paragraph --><p>U.S. Senate</p><!-- /wp:paragraph --><!-- wp:buttons --><div class="wp-block-buttons"><!-- wp:button --><div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="https://secure.actblue.com/donate/hswebsite" target="_blank" rel="noopener" aria-label="Donate to Hallie Shoffner via ActBlue, opens in a new tab">Donate via ActBlue</a></div><!-- /wp:button --><!-- wp:button --><div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="https://goodchange.app/donate/halli-gq?mk=website-7" target="_blank" rel="noopener" aria-label="Donate to Hallie Shoffner via GoodChange, opens in a new tab">Donate via GoodChange</a></div><!-- /wp:button --></div><!-- /wp:buttons --><!-- wp:paragraph {"className":"dc-campaign-site"} --><p class="dc-campaign-site"><a href="https://www.hallieshoffner.com/" target="_blank" rel="noopener" aria-label="Visit the Hallie Shoffner campaign website, opens in a new tab">Visit campaign website</a></p><!-- /wp:paragraph --></div><!-- /wp:column -->
...
<!-- wp:column --><div class="wp-block-column"><!-- wp:heading {"level":2} --><h2 class="wp-block-heading">Cynthia Nations</h2><!-- /wp:heading --><!-- wp:paragraph --><p>Arkansas House, District 55</p><!-- /wp:paragraph --><!-- wp:buttons --><div class="wp-block-buttons"><!-- wp:button --><div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="https://secure.actblue.com/donate/nations4ar" target="_blank" rel="noopener" aria-label="Donate to Cynthia Nations via ActBlue, opens in a new tab">Donate via ActBlue</a></div><!-- /wp:button --><!-- wp:button --><div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="https://goodchange.app/donate/natio-nh" target="_blank" rel="noopener" aria-label="Donate to Cynthia Nations via GoodChange, opens in a new tab">Donate via GoodChange</a></div><!-- /wp:button --></div><!-- /wp:buttons --><!-- wp:paragraph {"className":"dc-campaign-site"} --><p class="dc-campaign-site"><a href="https://www.nationsforarkansas.com/" target="_blank" rel="noopener" aria-label="Visit the Cynthia Nations campaign website, opens in a new tab">Visit campaign website</a></p><!-- /wp:paragraph --></div><!-- /wp:column -->
</div><!-- /wp:columns -->'
ensure_page "Donate" "donate" "$donate_content" >/dev/null
